...
| **C17** | No resume. **Superseded 2026-08-28 for `/crew`** — see `docs/adr/2026-08-28-resuming-an-interrupted-crew-run.md`; a crew run checkpoints per task and a rerun offers `resume`. Still true of `/lets`. | Model-level failure is already covered by `askAny` roster fallthrough + C10. Process-level death leaves the commits on the branch; re-run. |
